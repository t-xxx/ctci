...
def bits_different_2(a, b):
    ...
    counts = (counts & 0x3333333333333333) + \
        ((counts & 0xCCCCCCCCCCCCCCCC) >> 2)
    counts = (counts & 0x0F0F0F0F0F0F0F0F) + \
        ((counts & 0xF0F0F0F0F0F0F0F0) >> 4)
    counts = (counts & 0x00FF00FF00FF00FF) + \
        ((counts & 0xFF00FF00FF00FF00) >> 8)
    counts = (counts & 0x0000FFFF0000FFFF) + \
        ((counts & 0xFFFF0000FFFF0000) >> 16)
